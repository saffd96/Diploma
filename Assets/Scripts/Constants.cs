...
{
    public const string AttackValuePrefsKey = "AttackValue";
    public const string IsRangeAttackEnabledPrefsKey = "IsRangeAttackEnabled";
    public const string MaxSpeedPrefsKey = "MaxSpeed";
    public const string IsRunActivePrefsKey = "IsRunActive";
    ...
    public const string MaxHealthPrefsKey = "MaxHealth";
    public const string CurrentHealthPrefsKey = "CurrentHealth";
}
